...
public class PopupText {
	...
	private GameRecharge gameRecharge;
	
	public PopupText(GameRecharge gr) {
		this.gameRecharge = gr;
	}
	...
	public void popup() {
		boolean run = true;
		KeyState key = gameRecharge.getKeyState();
		Graphics g = gameRecharge.getGraphics();
		while (run) {
			show(g);
